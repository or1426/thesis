...
\subsection{Uncertainty regions}

\subsubsection{Warm-up: a review of position and momentum}\label{sec:qp}
...
\subsubsection{Uncertainty region: general definition}\label{sec:pur-def}
...
\subsection{Optimal qubit uncertainty relations}\label{sec:qubit}
...
\subsubsection{Uncertainty bounds for $\sigma_x,\sigma_y,\sigma_z$}\label{sec:xyz}
...
\subsubsection{Uncertainty region for general $\pm 1$-valued qubit measurements}
...
We begin by noting some simple known examples of state-independent uncertainty relations for the pair $\opa,\opb$ given in Ref.~\cite{BLW14}:
\begin{align}
...
\subsubsection{Schr\"odinger uncertainty relation}\label{sec:sch-uncertainty-relation}
...
\subsection{Qutrit uncertainty}
\label{sec:qutrit}
\subsubsection{Extended qubit observables}
...
\subsection{Uncertainty region for Gell-Mann observables}
...
\subsubsection{Exploring minima}
...
\subsubsection{Exploring maxima}
...
\subsubsection{The bounding curves}
