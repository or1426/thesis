...
\begin{figure}[H]
  ...
  \begin{subfigure}[b]{0.38\textwidth}
    ...
    \caption{The uncertainty region with $\boa\cdot\bob = \cos\frac{\pi}{16}$.}
    \label{fig:err-region-1-pi-by-16-1}
  \end{subfigure}\hfill
  \begin{subfigure}[b]{0.38\textwidth}
    ...
    \label{fig:err-region-1-pi-by-16-2}
  \end{subfigure}\\
  \begin{subfigure}[b]{0.38\textwidth}
    ...
    \label{fig:err-region-4-pi-by-16-1}
  \end{subfigure}\hfill
  \begin{subfigure}[b]{0.38\textwidth}
    ...
    \label{fig:err-region-4-pi-by-8-2}
  \end{subfigure}\\
  \begin{subfigure}[b]{0.38\textwidth}
    ...
    \label{fig:err-region-8-pi-by-16-1}
  \end{subfigure}\hfill
  \begin{subfigure}[b]{0.38\textwidth}
    ...
    \label{fig:err-region-8-pi-by-18-2}
  \end{subfigure}
...
\begin{align}
  0 &= \bob\cdot\bor \\
    &= b_1 r_1 + b_2 r_2 \\
    &= (\boa\cdot\bob) \sqrt{1-\varr{\opa}} + \norm{\boa\times\bob}{} r_2.\label{eqn:qubit-triple-r-orth-b}
\end{align}
